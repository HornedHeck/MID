...
val S = arrayOf(S_1, S_2, S_3, S_4, S_5, S_6, S_7, S_8)
...
private val shiftRelative = arrayOf(1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1)

private val shiftCumulative = Array(shiftRelative.size) {
    shiftRelative.take(it + 1).sum()
}

val CD = shiftCumulative.map { shift ->
    (C_0.drop(shift) + C_0.take(shift) + D_0.drop(shift) + D_0.take(shift)).toTypedArray()
}
